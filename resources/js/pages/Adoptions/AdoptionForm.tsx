...
interface AdoptionPageProps extends Record<string, unknown> {
    animal: Animal;
    user: User;
...
export default function AdoptionForm() {
    const { animal, user, profile } = usePage<AdoptionPageProps>().props;
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('adoptions.submit', animal.id), {
            onSuccess: () => reset(),
        });
    };
    ...
    return (
            ...
            actions={
                <>
                    ...
                    <Button asChild variant="secondary" className="w-full mt-2">
                        <Link href={route('adoptions.welcome', animal.id)}>
                            Cancelar
                        </Link>
                    </Button>
                </>
        ...
        >
            ...
            <div>
                <Label htmlFor="motivo">Motivo para adoptar</Label>
                <Input
                    id="motivo"
                    value={data.motivo}
